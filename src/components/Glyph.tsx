...
const P: Record<GlyphName, string> = {
  ...
  mic: "M12 3.4a2.6 2.6 0 0 0-2.6 2.6v6a2.6 2.6 0 0 0 5.2 0V6A2.6 2.6 0 0 0 12 3.4ZM5.5 11.4A6.5 6.5 0 0 0 12 18a6.5 6.5 0 0 0 6.5-6.6M12 18v3M9 21h6",
  "mic-off": "M4 4l16 16M9.4 6.2A2.6 2.6 0 0 1 14.6 6v5.2M14.6 14.1a2.6 2.6 0 0 1-5.2-1V9.6M5.5 11.4A6.5 6.5 0 0 0 15 17.4M18.5 11.4c0 .9-.2 1.7-.5 2.5M12 18v3M9 21h6",
  chat: "M20 12.4c0 3.9-3.6 7-8 7-.9 0-1.8-.1-2.6-.4L4 20.5l1.4-3.6A6.7 6.7 0 0 1 4 12.4c0-3.9 3.6-7 8-7s8 3.1 8 7Z",
  exit: "M14.5 4.5H6.4A1.4 1.4 0 0 0 5 5.9v12.2a1.4 1.4 0 0 0 1.4 1.4h8.1M16 8.5 19.5 12 16 15.5M19.5 12H10",
